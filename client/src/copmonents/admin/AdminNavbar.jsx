        ...
        <Container>
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="ms-auto align-items-lg-center">
              ...
              <Nav.Link as={NavLink} to="/admin/services" className="nav-link-custom">
                <Grid size={18} />
                Services
              </Nav.Link>

              <Nav.Link as={NavLink} to="/admin/team" className="nav-link-custom">
                <People size={18} />
                Team
              </Nav.Link>

              <Nav.Link as={NavLink} to="/admin/appointments" className="nav-link-custom">
